...
#include <memory>
#include "../../qt-tcp-socket-programming/clientApp/mytcpclient.h"
...
QT_MOC_LITERAL(174, 8), // "username"
QT_MOC_LITERAL(183, 7) // "balance"
...
void MyTcpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 8: _t->operations((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        default: ;
        }
